...
public class DataBaseUtility {
    ...
    String PASSWORD;
	 ...
	 public DataBaseUtility(){
			String filepath;
			try {
				filepath = fLib.getFilepathFromPropertyFile("DataBaseConf");
			
			URL = fLib.getValueOfEnvirmentalData(filepath, "url");
			USERNAME = fLib.getValueOfEnvirmentalData(filepath, "username");
			PASSWORD = fLib.getValueOfEnvirmentalData(filepath, "password");
			} catch (IOException e) {
